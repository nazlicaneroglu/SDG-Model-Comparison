...
# Display the count
print("Count of sdg3 texts = 1:", count_sdg3) #1101
print("Count of sdg3 keywords = 1:", count_sdg3_keywords) #717
...
features = df.iloc[:, -521:]
target = df['sdg_2_dummy']
'''
...
print(coefficients)
coefficients.to_csv('coefficients_sdg2_ridge.csv', index=False)
